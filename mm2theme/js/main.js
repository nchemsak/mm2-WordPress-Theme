...
$(document).ready(function() {
   ...
   var audio = document.getElementById("audio");
            audio.play("/public_html/wp-content/themes/mm2theme/audio/slap.mp3");
            $('.eagle-eye, body').addClass('nick');
            var millisecondsToWait = 100000;
            setTimeout(function() {
    ...
    //BUZZ button
    $("#play_button_buzz").click(function() {
        // var buzz = function() {
        var buzz = document.getElementById("buzz");
        buzz.play("/public_html/wp-content/themes/mm2theme/audio/buzz.mp3");
